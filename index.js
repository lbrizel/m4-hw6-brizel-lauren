...
function getPizzaOrder() {
  ...
  var toppingsInput = prompt("Please enter additional toppings (comma separated)")
  ...
  if (toppingsInput === "") {
    ...
    var moreToppings = toppingsInput.split(",")
    pizza.toppings = moreToppings
    pizza.cost += moreToppings.length * toppingsFee
  }
